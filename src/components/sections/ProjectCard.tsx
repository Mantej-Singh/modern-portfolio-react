...
export function ProjectCard({ project, index }: ProjectCardProps) {
  ...
  return (
    ...
    >
      <motion.div
        className="cursor-target bg-card border border-border rounded-xl p-6 shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden relative h-full flex flex-col"
